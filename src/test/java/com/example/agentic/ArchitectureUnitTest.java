...
class ArchitectureUnitTest {
    ...
    @Test void urlPolicyRejectsLoopbackAndPrivateNetworks(){var policy=new SecureUrlPolicy();assertThatThrownBy(()->policy.validate("http://localhost/admin")).hasMessageContaining("public absolute");assertThatThrownBy(()->policy.validate("http://192.168.1.10/admin")).hasMessageContaining("public absolute");assertThatThrownBy(()->policy.validate("http://[::1]/admin")).hasMessageContaining("public absolute");}
}
